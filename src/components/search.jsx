...
const search = ({searchUser, valueInput, setValue}) => {
  ...
  const handleClick = async () => {
    ...
    const response = await user(valueInput);
    if (response.message) {
      searchUser({
        name: '',
        image: '',
  ...
  return (
    <div>
      <label>
        <input type="text" placeholder="Digite um usuário do Github" onChange={onChangeValue} />
